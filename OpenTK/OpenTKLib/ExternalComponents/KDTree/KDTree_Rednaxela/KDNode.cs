...
namespace KDTreeRednaxela
{
    ...
    public class KDNode_Rednaxela<T>
    {
        ...
        /// </summary>
        protected internal double[][] points;
        ...
        /// </summary>
        protected internal KDNode_Rednaxela<T> pLeft, pRight;
        /// <summary>
        /// The split dimension.
        /// </summary>
        ...
        /// </summary>
        protected internal double[] minBound, maxBound;
        ...
        protected KDNode_Rednaxela(int iDimensions, int iBucketCapacity)
        {
            ...
            // Setup leaf elements.
            this.points = new double[iBucketCapacity+1][];
        ...
        {   
            Array.Resize<double[]>(ref points, points.Length * 2);
        ...
        private bool CalculateSplit()
        {
            ...
            fSplitValue = (minBound[splitDimension] + maxBound[splitDimension]) * 0.5;
