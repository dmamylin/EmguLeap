...
namespace NLinear
{
        ...
        where T : IEquatable<T>
    {
        ...
        public Vector3<T> ReflectPoint(Vector3<T> point, Func<double, T> fromDouble = null)
        {
            if (fromDouble == null)
        ...
        public Vector3<T> ClosestPoint(Vector3<T> point, Func<double, T> fromDouble = null)
        {
        ...
        public Vector3<T> ReflectVector(Vector3<T> v, Func<double, T> fromDouble = null)
        {
            if (fromDouble == null)
                fromDouble = Numeric<T>.FromDouble;
